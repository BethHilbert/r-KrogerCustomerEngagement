...
carbo <- carbo %>%
  filter (!display_desc %in% c("Pre-Collection", "Unknown"))
```
...
Next I looked at the data through the lens of product. I arranged the data so that one product is a single row in the dataframe. I summarized the number of times over the two year period this product was part of specific displays, calculated quantities, number of baskets, dollars, stores.
...
```{r}
# Plot the relationship between two selected variables and color lines by the assigned cluster
